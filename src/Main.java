...
public class Main {
    ...
    public static final String EXIST_PHONES   = "EP";
    ...
    public static final String PHONES_EXIST = "There are contacts that share phone numbers.";
    private static final String PHONES_NOT_EXIST = "All contacts have different phone numbers.";
    ...
    private static void getNumber(Scanner in, ContactBook cBook){
        ...
        if (cBook.hasPhoneNumber(phone)) {
            String name = cBook.searchByPhoneNumber(phone);
            System.out.println(name);
        }
        else System.out.println(PHONE_NOT_EXIST);
    }

    private static void existPhones(ContactBook contactBook){
        if (contactBook.searchSamePhones()) {
            System.out.println(PHONES_EXIST);
        }
        else System.out.println(PHONES_NOT_EXIST);
    }
}
